package com.example.maria.prova.util;
 ...
 */
public class EditTextTelefone extends EditText{
        ...
        public EditTextTelefone(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            initialize();

        }

        public EditTextTelefone(Context context, AttributeSet attrs) {
            super(context, attrs);
            initialize();

        }

        public EditTextTelefone(Context context) {
            super(context);
            initialize();
        ...
        public String getCleanText() {
            String text = EditTextTelefone.this.getText().toString();
        ...
        private void initialize() {
            ...
            this.addTextChangedListener(new TextWatcher() {
				 ...
				 */
                    isUpdating = true;
                    EditTextTelefone.this.setText(phone);

                    EditTextTelefone.this.setSelection(positioning[length]);
